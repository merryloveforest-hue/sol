        ...
        <div className="container">
          ...
          <div className="product-grid">
            {[
              ...
              { name: "프리미엄 붓펜 세트", price: "55,000", img: "https://images.unsplash.com/photo-1581337204873-ef36aa186caa?auto=format&fit=crop&q=80&w=800" },
              { name: "전통 한지 노트", price: "18,000", img: "https://images.unsplash.com/photo-1544816155-12df9643f363?auto=format&fit=crop&q=80&w=800" }
            ].map((prod, i) => (
